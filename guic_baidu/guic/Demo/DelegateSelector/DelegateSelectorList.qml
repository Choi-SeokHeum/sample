...
Loader {
    ...
    function retDelegate(type)
    {
        switch (type)
        {
        case 0: return "qrc:///Delegate/List/DelegateText.qml"
        case 1: return "qrc:///Delegate/List/DelegateIconText.qml"
        case 2: return "qrc:///Delegate/List/DelegateCheckText.qml"
        case 3: return "qrc:///Delegate/List/DelegateCheckIconText.qml"
        case 4: return "qrc:///Delegate/List/DelegateDirectionDistanceIconText.qml"
        case 5: return "qrc:///Delegate/List/DelegateSubTitle.qml"
        }
    }
}
