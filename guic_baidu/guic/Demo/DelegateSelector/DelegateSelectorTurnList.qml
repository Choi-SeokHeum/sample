...
Loader {
    ...
    function retDelegate(type)
    {
        switch (type)
        {
        case 0: return "qrc:///Delegate/TurnList/DelegateTurnListTollGate.qml"
        case 1: return "qrc:///Delegate/TurnList/DelegateTurnListRestArea.qml"
        case 2: return "qrc:///Delegate/TurnList/DelegateTurnListPosition.qml"
        }
    }
}
