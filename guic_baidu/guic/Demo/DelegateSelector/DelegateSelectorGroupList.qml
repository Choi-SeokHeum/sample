...
Loader {
    ...
    height: listView.height/listView.countInView
    ...
    function retDelegate(type)
    {
        switch (type)
        {
        case 0: return "qrc:///Delegate/GroupList/DelegateGroupTwoButton.qml"
        case 1: return "qrc:///Delegate/GroupList/DelegateGroupThreeButton.qml"
        case 2: return "qrc:///Delegate/GroupList/DelegateGroupFourButton.qml"
        case 3: return "qrc:///Delegate/GroupList/DelegateGroupFiveButton.qml"
        }
    }
}
